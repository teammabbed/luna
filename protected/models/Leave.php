...
class Leave extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('leave_id, leave_type, emp_number, leave_reason, status, leave_days, date_filed, head1, head2, head1_action_date, head2_action_date, head1_action, head2_action, remarks, date_created, leave_year', 'required'),
			...
			array('leave_id, leave_type, emp_number, leave_reason, status, leave_days, date_filed, head1, head2, head1_action_date, head2_action_date, head1_action, head2_action, remarks, date_created, leave_year', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'empLeaveDetails' => array(self::HAS_MANY, 'EmpLeaveDetail', 'leave_id'),
		);
	}
